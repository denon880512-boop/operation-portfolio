...
function createTextTexture(gl, text, font = 'bold 30px sans-serif', color = '#111111') {
...
class Title {
  constructor({ gl, plane, text, textColor = '#111111', font = 'bold 30px sans-serif' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
    this.text = text;
...
function CircularGallery({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="循环视觉作品画廊，可拖拽或使用左右方向键浏览"
    />
  );
}
